 ...
 */
// 佳明中国区账号及密码
export const GARMIN_USERNAME_DEFAULT = process.env.GARMIN_USERNAME_DEFAULT || '21660611@163.com';
export const GARMIN_PASSWORD_DEFAULT = process.env.GARMIN_PASSWORD_DEFAULT || 'jmm112233J';
// 佳明国际区区账号及密码
export const GARMIN_GLOBAL_USERNAME_DEFAULT = process.env.GARMIN_GLOBAL_USERNAME_DEFAULT || '21660611@qq.com';
export const GARMIN_GLOBAL_PASSWORD_DEFAULT = process.env.GARMIN_GLOBAL_PASSWORD_DEFAULT || 'jmm112233J';
// 佳明迁移数量配置
export const GARMIN_MIGRATE_NUM_DEFAULT = process.env.GARMIN_MIGRATE_NUM_DEFAULT || '100';
